...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post translations_url, params: { translation: { progression: @translation.progression, user_id: @translation.user_id, word_1_id: @translation.word_1_id, word_2_id: @translation.word_2_id } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { progression: @translation.progression, user_id: @translation.user_id, word_1_id: @translation.word_1_id, word_2_id: @translation.word_2_id } }
